        ...
        switch ($selectedOption) {
            case 'team_member':
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td data-label='Role'>" . htmlspecialchars($row['description']) . "</td>";
                    if ($isAdmin) {
                        echo "<td data-label='Action'><a href='edit_team_member.php?idteam=" . $idteam . "'>Hapus</a></td>";
                    }
                    echo "</tr>";
                }
                echo "</table>";
            ...
            case 'achievement':
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($isAdmin) {
                        ...
                        echo "<td data-label='Edit'><a href='achievement_edit.php?idachievement=" . $row['idachievement'] . "'><button>Edit</button></a></td>";
                    }
                    echo "</tr>";
                }
                echo "</table>";
            ...
            case 'event':
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($isAdmin) {
                        ...
                        echo "<td data-label='Edit'><a href='event_edit.php?idevent=" . $row['idevent'] . "'><button>Edit</button></a></td>";
                    }
                    echo "</tr>";
                }
                echo "</table>";
